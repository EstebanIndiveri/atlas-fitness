...
export const SESSION_COPY = {
  ...
  replace: 'Reemplazar',
  notes: 'Notas',
  showTechnique: 'Mostrar técnica',
  showReplace: 'Mostrar reemplazo',
  showNotes: 'Mostrar notas',
  notesEmpty: 'Sin notas cargadas para este ejercicio.',
  replaceHelper: 'Elegí cómo seguir sin perder las series ya registradas.',
  replaceSkip: 'Saltar este ejercicio',
  replaceHold: 'Posponer para más tarde',
