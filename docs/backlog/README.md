...
Este backlog refleja `develop` tras los PR #130–#137. v0.7.0 se publicó con el tag sobre `dae2bc949538f9cb9fa02faf8db0712d04b9d9f9`. El PR de release #138 se fusionó en `main` como `ba0857c5c42f730263e2d735ff57e69f6b0d42ea`, con las versiones de paquete en 0.7.1; esta PR finaliza los metadatos de publicación. Al snapshot 2026-09-25, `v0.7.1` todavía no tiene tag ni GitHub Release. Después de mergear esta PR, crear el tag sobre el commit final de `main` resultante de este merge; hasta entonces no declarar v0.7.1 como publicada. El CI de los cambios de producto pasó en el run 36201073118. Este backlog convive con la visión estratégica de [`handoff-atlas-adaptive-core.md`](./handoff-atlas-adaptive-core.md): ese documento marca el norte de **Atlas Adaptive Core V1**; este README traduce el estado operativo y lo que queda. Para el checkpoint paso-a-paso y evidencia de pruebas ver [`handoff-2026-09.md`](./handoff-2026-09.md).
